...
def update_stock_price_json_file(stock_type, average_stock_price):
    """
...
async def get_all_stock_prices(stock_dict):
    ...
    if stocks_prices:
        ...
        for key in stock_dict.keys():
            ...
            _prices = [(x_stock[0], x_stock[2]) for x_stock in stocks_prices if x_stock[1] == key]
            ...
            print(f'The average {key} price is: {stock_average_price} KD')
            print()
